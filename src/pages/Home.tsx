          ...
          <div className="lg:col-span-5 flex flex-col gap-1">
            ...
            <div className="border-2 border-madia-gold p-6 lg:p-10 bg-madia-green rounded-2xl flex flex-col gap-3">
              ...
              <div className="flex items-center justify-center gap-6">
                ...
                <a href="https://www.iljerryteramo.it" target="_blank" rel="noopener noreferrer" aria-label="Il Jerry Teramo" className="opacity-80 hover:opacity-100 transition-opacity duration-300">
                  <img src="/logojerry-removebg-preview.png" alt="Il Jerry Teramo" loading="lazy" className="h-16 w-24 object-contain" style={{ filter: 'brightness(0) saturate(100%) invert(62%) sepia(80%) saturate(350%) hue-rotate(358deg) brightness(88%)' }} />
                </a>
              </div>
            </div>
